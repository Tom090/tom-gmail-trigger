...
OperationHandlerTest_1.OperationHandlerTestSetup.configureHandlerTest(handler_1.webhookCreateHandler, (handlerTest) => handlerTest
    ...
    .givenNothing()
    .when(() => ({ public_url: "https://00000000-1111-0000-0000-4ceb95fc04c8.trayapp.io", eventTypes: input_1.eventTypes.messageAdded, authId: "87f51502-0000-4d12-88d1-1511fb095082", threadId: '0000000' }))
    .then(({ output }) => {
    console.log(output);
...
OperationHandlerTest_1.OperationHandlerTestSetup.configureHandlerTest(handler_1.webhookDestroyHandler, (handlerTest) => handlerTest
    ...
    .givenNothing()
    .when(() => ({ public_url: "https://00000000-1111-0000-0000-4ceb95fc04c8.trayapp.io", eventTypes: input_1.eventTypes.messageAdded, authId: "87f51502-18cb-4d12-88d1-1511fb095082", threadId: '0000000' }))
    .then(({ output }) => {
    console.log(output);
